...
(function (B) {
    ...
    B.color.make = function (F, E, C, D) {
        ...
        G.a = D != null ? D : 1;
        G.add = function (J, I) {
            for (var H = 0; H < J.length; ++H) {G[J.charAt(H)] += I}
            return G.normalize()
        };
    ...
    B.color.parse = function (F) {
        ...
        if (D == "transparent") {return C(255, 255, 255, 0)} else {
            E = A[D] || [0, 0, 0];
    ...
    function Plot(placeholder, data_, options_, plugins) {
        ...
        var series = [],
            options = {
                ...
                colors: ["#3def4a", "#afd8f8", "#cb4b4b", "#4da74d", "#9440ed"],
                legend: {
                    show: true,
                    noColumns: 1, // number of colums in legend table
                    labelFormatter: null, // fn: string -> string
                    labelBoxBorderColor: "#cccac8", // border color for the little label boxes
