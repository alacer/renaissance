...
(function (f) {
    ...
    function p(a, c, d) {
        ...
        if (!0 !== b[c]) {
            if (!d && c == j && b[l] == x && b.name) {
                ...
                s.each(function () {this !== b && f.data(this, n) && w(f(this), c)})
            }
    ...
    function h(a, c, d) {if (f.data(a, n))return f.data(a, n).o[c + (d ? "" : "Class")]}

    function y(a) {return a.charAt(0).toUpperCase() + a.slice(1)}
